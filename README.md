...
9. **we send it to the server with the command**
...
6. change the ownership to the openldap user by running
...
3. Copy the public key to the ldap
   ```
...
5. Restart ssh service
   ...
   ```
6. Connect to the ldap user without the need of a password
...
4. Enable LDAP authentication, 
	...
	a2enmod authnz_ldap.
	``` 
6.  Specify the allowed memebers to access the website on the apache server
...
8. Define the attribute memberUid
...
![](https://lh7-us.googleusercontent.com/4Y5az2gdRdYyToVJY9dpFlOKsxzfVMEzgXWfTwcjm0MA43oSpjjUJeSnVV2_6baLgdrw9UFFjKOLrOFlpU9lxLmtr-DSs6LrhvFeokHHzaM9fwMiFjGYrmYeaEEwCyNiSuUfCrbAq7YY)
...
![](https://lh7-us.googleusercontent.com/URo7bDWeTZcjwFIStZjFMvcy8QIou7GeRUJ2rjUCTLLkj1-I3SFgs2Dwc8jHCt8Twe962PDjHJNyrlBAZtgrSSxPNkbmUEEemymi_vt1x8s-laq7uRsn_-TfTtyHWGtb2SPRsgMQRgGc)

In the client machine, we can now connect to the diffrent servers with the names  specified in named.conf
